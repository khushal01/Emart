...
public class AddEmployeeFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(!validateInput()){
            JOptionPane.showMessageDialog(null, "Please Enter all details", "Incomplete Details !", JOptionPane.ERROR_MESSAGE);
            return;
        }
        else{
            try{
            ...
            return;
                ...
                JOptionPane.showMessageDialog(null, "Please input numeric values only", "Invalid Input", JOptionPane.ERROR_MESSAGE);
                   nfe.printStackTrace();
                   return;
            }
        }
    ...
    private  boolean validateInput(){
        ...
        String empSal=txtEmployeeSalary.getText();
